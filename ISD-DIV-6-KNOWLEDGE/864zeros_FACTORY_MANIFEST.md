# 864zeros: Factory Manifest [v1.6]
...
## V. Recommended Strike Sequence (priority-ordered, post-Strike-022)
...
| ~~P0~~ | ~~clipboard RULE-007 §Disclosure block~~ | — | ✅ **CLOSED** in Strike 022 (verbatim from audit §VI.a) |
...
| **P0 (NEW)** | Chronicle ExtPay implementation per `CHRONICLE_CHECKOUT_BLUEPRINT.md` — 3 entry points (SW initPayments+onPaid, Options page openPaymentPage, shared TIER_UNLOCKED broadcast listener) | ~3-4h | Promotes Chronicle from Rung-4-stub → Rung-4-real-payment; enables public release |
...
*864zeros Factory Manifest v1.6 · 2026-05-09 · 864zeros LLC · DIV-6-KNOWLEDGE.*
